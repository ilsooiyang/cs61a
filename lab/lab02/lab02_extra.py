...
def generator():
    ...
    caesar5 = caesar_generator(5, add)
    brutus3 = caesar_generator(3, sub)
    brutus5 = caesar_generator(5, sub)
    f1, f2, f3 = looper(caesar3), looper(mirror_letter), looper(brutus5)
    encrypter = make_encrypter(f1, f2, f3)
    f1, f2, f3 = looper(brutus3), looper(mirror_letter), looper(caesar5)
    decrypter = make_decrypter(f1, f2, f3)
